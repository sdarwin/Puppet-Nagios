class nagios::base {
    ...
    file { 'nagios_main_cfg':
            ...
            source => [ "puppet:///modules/site-nagios/configs/${fqdn}/nagios.cfg",
                        "puppet:///modules/site-nagios/configs/${::osfamily}/nagios.cfg",
    ...
    file { 'nagios_cgi_cfg':
        ...
        source => [ "puppet:///modules/site-nagios/configs/${fqdn}/cgi.cfg",
                    "puppet:///modules/site-nagios/configs/${::osfamily}/cgi.cfg",
    ...
    file { 'nagios_private_resource_cfg':
        ...
        source => [ "puppet:///modules/site-nagios/configs/${::osfamily}/private/resource.cfg.${::architecture}",
